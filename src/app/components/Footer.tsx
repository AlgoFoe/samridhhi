  ...
  return (
    <footer className="h-96 w-full bg-black-900 p-4 border-t">
      <div className="h-2/4 w-full container mx-auto  text-center flex justify-evenly items-center">
        ...
        <a href="#" className="flex items-center mb-4 md:mb-0">
          <Image src="/Government_of_India_logo.svg" alt="Logo" width={140} height={140} className="w-20 h-auto bg-contain" />
        </a>
        <a href="#" className="flex items-center mb-4 md:mb-0">
        ...
        <a href="#" className="flex items-center mb-4 md:mb-0 ">
          <Image src="/image.jpeg" alt="Logo" width={140} height={110} className="w-16 h-auto bg-contain" />
        </a>
      </div>
    </footer>
  );
